...
const resources = {
  ...
  en: {
    translation: {
      ...
      gastronomia_sanManuel:
        "<p>In San Manuel, the gastronomy is characterized by its simplicity and authenticity. The town offers a variety of dining options where you can savor traditional flavors in a warm and welcoming atmosphere.</p><p>You can enjoy a hearty meal at local restaurants that serve homemade dishes, or opt for a quick bite at cafes and bakeries that offer delicious pastries and snacks.</p><p>Don’t miss the opportunity to try local specialties, such as grilled meats, empanadas, and homemade pasta, which reflect the culinary traditions of the region.</p><p>Whether you’re looking for a full dining experience or just a coffee break, San Manuel has something to satisfy every palate.</p>",
      transporte_san_manuel:
        "<p>To move around comfortably and without worries during your visit, we inform you that the town offers private transportation services.</p><p>If you need to get to your accommodation, a restaurant or any point of interest, you can rely on the available <strong>taxi services</strong>. These vehicles offer you a flexible and safe option to move at your own pace.</p>",
      //Arenas Verdes Actualizado
